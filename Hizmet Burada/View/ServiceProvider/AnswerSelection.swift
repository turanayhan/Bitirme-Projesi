...
class AnswerSelection: UIViewController, UITableViewDataSource, UITableViewDelegate {
...
class AnswerTableViewCell: UITableViewCell {
    ...
    @objc func switchValueChanged() {
        ...
        RegistrationInformation.rgİnformation.addInfo(value: answerLabel.text ?? "nul")
    }
}

extension AnswerSelection: AnswerTableViewCellDelegate {
    func switchValueChanged(forCell cell: AnswerTableViewCell) {
    ...
    @objc func nextButtonTapped(click : UIButton!){
        navigationController?.pushViewController(RgExtrainformation(), animated: true)
