...
class Opportunity: UIViewController ,UITableViewDataSource, UITableViewDelegate {
    ...
    func tableView(_ tableView: UITableView, heightForRowAt indexPath: IndexPath) -> CGFloat {
            return 150  // Örnek: Hücre yüksekliği 80 piksel
        }
    ...
    func getData(){
          let ref = Database.database().reference()
              ...
              ref.child("İs Bilgileri").observe(.value, with: { snapshot in
