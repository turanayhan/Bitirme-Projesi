...
class RecipientName: UIViewController {
    ...
    lazy var nameSurnameText2:UITextView = {
        let infoText = UITextView()
        infoText.text = "Hizmet sağlayıcılar, profilinizde ve teklif mesajlarınızda adınızı görecekler. İsminizin ve soyisminizin baş harflerini büyük yazmanız, daha profesyonel \nbir izlenim bırakacaktır."
        infoText.textColor = .black
        infoText.textAlignment = .center
        infoText.backgroundColor = UIColor(hex: "#F1FAFE")
